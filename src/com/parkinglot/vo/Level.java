...
public class Level {
	...
	public boolean initFloorSlots(List<SlotType> slotList) {
		int index = 0;
		for(SlotType type: slotList) {
			ParkingSlot slot = new ParkingSlot(levelId+"-"+index, type);
			...
			slotById.put(levelId+"-"+index, slot);
		}
